	...
	exports.default = {
	  ...
	  created: function created() {
	    this.__update = (0, _utils.delayer)(function () {
	      ...
	      this.asign = '';
	      if (this.async) {
	        this.asyncFunc(this.async, this.val).then(function (data) {
